...
test('npm_config_build_wasm from source when passed in the environment', function (t) {
  const env = {
...
test('npm_config_build_wasm from source when passed as argument', function (t) {
  const args = [
